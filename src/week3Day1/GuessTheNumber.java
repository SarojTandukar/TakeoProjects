...
public class GuessTheNumber {
    public static void main(String[] args) {
        ...
        System.out.println("Maximun attempt is 5");
         int i = 0;
        while (i <= 10) {
...
/*Exercise 2 :  Create a program that implements a basic text-based game using core Java concepts like classes, objects, loops, and conditional statements.
        ...
        In this game, the player first sets the range of numbers within which the secret number will be generated. The program then randomly generates a secret number within that range.The player has a maximum number of attempts (5 in this case) to guess the secret number correctly. After each guess, the program provides feedback to the player, telling them whether the guessed number is too high or too low. If the player guesses the correct number, the game ends with a congratulatory message. If the player uses all the attempts without guessing the correct number, the game ends with a message revealing the secret number.
        ...
        Generate secret number by using inbuilt class Random random = new Random();with formula : int secretNumber =  random.nextInt(maxRange - minRange + 1) + minRange;
